          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-body">
                ...
                <p class="card-text">¡Bienvenido a La Vía Láctea de Sabores! Aquí podrás encontrar información sobre nuestro restaurante y las diferentes funcionalidades que ofrecemos.</p>
              </div>
            </div>
          </div>
        </div>
